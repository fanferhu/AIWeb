...
def parsers():
    ...
    parser.add_argument("--bert_pred", type=str, default="../bert_classification/bert-base")
    ...
    parser.add_argument("--save_model_best", type=str, default=os.path.join("../bert_classification/model", "best_model.pth"))
    parser.add_argument("--save_model_last", type=str, default=os.path.join("../bert_classification/model", "last_model.pth"))
